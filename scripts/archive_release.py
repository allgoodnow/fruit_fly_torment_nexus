...
bundle = ROOT / "dist" / "FruitFlyNexus-0.13.0"
report_path = ROOT / "runs" / "ui_packaged_acceptance" / "acceptance.json"
report = json.loads(report_path.read_text())
if not report.get("success") or report.get("version") != "0.13.0":
...
archive = ROOT / "dist" / "fruit-fly-nexus-0.13.0-linux-x86_64.tar.gz"
