...
bundle = ROOT / "dist" / "FruitFlyNexus-0.5.0"
report_path = ROOT / "runs" / "food_packaged_acceptance" / "acceptance.json"
...
archive = ROOT / "dist" / "fruit-fly-nexus-0.5.0-linux-x86_64.tar.gz"
