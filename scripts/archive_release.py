...
bundle = ROOT / "dist" / "FruitFlyNexus-0.9.0"
report_path = ROOT / "runs" / "male_cns_packaged_acceptance" / "acceptance.json"
...
archive = ROOT / "dist" / "fruit-fly-nexus-0.9.0-linux-x86_64.tar.gz"
