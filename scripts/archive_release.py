...
bundle = ROOT / "dist" / "FruitFlyNexus-0.8.0"
report_path = ROOT / "runs" / "behavior_packaged_acceptance" / "acceptance.json"
...
archive = ROOT / "dist" / "fruit-fly-nexus-0.8.0-linux-x86_64.tar.gz"
