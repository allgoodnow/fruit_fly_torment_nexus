...
bundle = ROOT / "dist" / "FruitFlyNexus-1.1.0"
report_path = ROOT / "runs" / "thermal_graph_packaged_acceptance" / "acceptance.json"
report = json.loads(report_path.read_text())
if not report.get("success") or report.get("version") != "1.1.0":
...
archive = ROOT / "dist" / "fruit-fly-nexus-1.1.0-linux-x86_64.tar.gz"
